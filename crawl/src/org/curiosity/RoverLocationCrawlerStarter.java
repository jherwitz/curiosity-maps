...
/**
 * Stopgap for missing locations from cspice (due to my inexperience w/ the tool).
 *
 * In the long term, the number of locations generated by web crawling will converge to zero as
 * we pull all of our data from cspice directly.
 *
 * Note: The NASA data is currently BROKEN - we'll have to rely on cspice for now.
 *
 * @author jherwitz
 */
